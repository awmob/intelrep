        ...
        <div class="row" id="article_bottom">

          <div id="articlemargins_footer" class="text-center">
            <hr>
            ...
            <?php
              ...
              if($next){
                ...
                <a class="mainlink font_bold" href="<?php the_permalink($next->ID) ?>"><?php echo $next->post_title; ?></a>
              ...
              if($prev){
                ...
                ?>
                 ...
                 <br>
                  <a class="mainlink font_bold" href="<?php the_permalink($prev->ID) ?>"><?php echo $prev->post_title;?></a>
